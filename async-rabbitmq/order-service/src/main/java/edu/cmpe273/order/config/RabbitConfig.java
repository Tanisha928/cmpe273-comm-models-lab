...
public class RabbitConfig {
  ...
  @Bean
  public TopicExchange ordersExchange() { return new TopicExchange(EX_ORDERS, true, false); }

  @Bean
  public TopicExchange ordersDlxExchange() { return new TopicExchange(EX_ORDERS_DLX, true, false); }

  @Bean
  public TopicExchange inventoryExchange() { return new TopicExchange(EX_INVENTORY, true, false); }
  ...
  @Bean
  public Queue orderPlacedDlq() { return new Queue(Q_ORDER_PLACED_DLQ, true); }
